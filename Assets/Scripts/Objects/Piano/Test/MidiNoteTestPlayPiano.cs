...
public class MidiNoteTestPlayPiano : MonoBehaviour
{
    [Header("Fichier MIDI")]
    ...
    void BuildMapping() //construire le cache
    {
        ...
        {
            noteToKey[n] = GetKeyGameObjectFromNoteNumber(n);
        }
    }
        ...
        foreach (var group in groupedNotes)
        {
            ...
            foreach (var note in group)
            {
                ...
                NoteData noteData = new NoteData()
                {
                    ...
                    duration = duration,
                    pianoKeyObj = noteToKey[note.NoteNumber]
                };
    ...
    */
    ...
    IEnumerator PlayAudioAndMIDI()
    {
        ...
        for (int index = 0; index < musicArray.Length; index++)
        {
            ...
            double notePlayTime = startDspTime + group.time;
            ...
            foreach (var note in group.notes)
            {
                ...
                StartCoroutine(AnimateKey(note.pianoKeyObj, note.duration));
            }
        }
    ...
    System.Collections.IEnumerator AnimateKey(GameObject key, float duration)
    {
        // Récupère le renderer et la couleur originale
        //MeshRenderer renderer = key.GetComponent<MeshRenderer>();
       // Color originalColor = renderer.material.color;

        // Change la couleur en rouge pour indiquer que la note est jouée
       // renderer.material.color = Color.red;
        ...
        // Maintient la touche appuyée pendant la durée exacte
        double noteEndTime = AudioSettings.dspTime + duration;
        while (AudioSettings.dspTime < noteEndTime)
            yield return null;
        ...
        // Reviens à la couleur originale
